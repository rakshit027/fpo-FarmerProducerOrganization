...
if (isset($_POST["Submit"])) {
  ...
  if ($eemail==$email) {
    $_SESSION["Successmsg"]="Email Exists now change your password";
    redirect_to("pwd1.php");
  } else {
    $_SESSION["Errormsg"]="Email Does not Exists";
    redirect_to("forgetpassword1.php");
  }
      ...
      <div class="offset-sm-3 col-sm-6" style="min-height:650px;">
        ...
        <div class="card bg-secondary text-light">
          <div class="card-header">
            ...
            <form class="" action="forgetpassword1.php" method="post">
              <div class="form-group">
                <label for="username"><span class="FieldInfo text-light">Email :</span></label>
